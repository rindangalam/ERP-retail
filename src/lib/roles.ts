...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { title: "Sales Order", href: "/sales-orders", roles: ["admin"], icon: FileText },
  ...
  { title: "Kasir", href: "/pos", roles: ["admin", "sales"], icon: Store },
  ...
  { title: "Laporan Butik", href: "/reports/butik", roles: ["admin", "sales"], icon: TrendingUp },
